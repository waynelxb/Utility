...
# class EmailCannotAvailableCountTime(Exception):
#    """Raised when cannot find the file"""
#    pass
...
def sqlite_check_email_usability(email, appt_time, court_number):    
    ...
    check_email_query=" select LoginEmail " \
                     ...
                     # +" where AppointmentStatus='EmailOverused' and LoginEmail='"+email + "' and AppointmentTime='"+ appt_time+"' and CourtNumber="+str(court_number)  
...
#     sqliteConnection = sqlite3.connect('TennisAppointment.db')
#     cursor=sqliteConnection.cursor()     
#     appt_week_start_date="date('"+ appt_time +"', 'weekday 0', '-7 days')"
#     # appt_week_end_date="date('"+ appt_time +"', 'weekday 6', '0 days')"
...
#     #### check whether the email has been used more than 3 times in the target week.     
#     check_email_query="""select LoginEmail
#                       from Appointment                          
#                       where AppointmentStatus='Succeeded'  
#                       and LoginEmail='"""+email + """' and AppointmentTime >=""" + appt_week_start_date +""" group by LoginEmail having count(1)>=3
#                       """
#     query_extension=""" 
#                       union 
#                       select LoginEmail
...
#     check_email_query=check_email_query+query_extension              
#     cursor.execute(check_email_query) 
#     query_result=cursor.fetchone()      
#     cursor.close()
#     if str(query_result)=="None":
...
try:
 ...
 ######## generate summary message 
        ...
        if(n>2):
            ...
            if(appointment_date.weekday()>=5):
                ...
                list_military_hour_option=[16,17,18,19,15,14,13]           
 ...
 ######## generate summary message            
    ...
    ######## Switch to calendar page to pick date and time  
        ...
        if check_exists_by_xpath(xpath_element_active_date) == True:
            ...
            if check_exists_by_xpath(xpath_element_no_date_available_due_to_login_email_overused) == True:
                driver.quit()                    
            ...
            elif check_exists_by_xpath(xpath_element_no_date_available_due_to_court_overbooked) == True:       
                driver.quit()                                 
...
# except EmailCannotAvailableCountTime:
#     msg_summary="Exception: "+court_name+" is not available for any time slot on "+str_appointment_date+ ".\n"+sqlite_get_appointment()
#     print(msg_summary)
#     log_process(log_path, msg_summary)    
#     send_email(msg_summary, "Failed")
